...
#endif
{
    ...
    juce::NormalisableRange<float> microTuneRange(-1.0f, 1.0f, 0.001f);
    ...
    apvts.createAndAddParameter("CleaningLevel", "Noise Cleaning Level", "CleaningLevel", noiseCleaningRange, 500.0f, nullptr, nullptr);

    apvts.createAndAddParameter("MicroTune", "Micro Tune", "MicroTune", microTuneRange, 0.0f, nullptr, nullptr);

    apvts.createAndAddParameter("Attack", "Attack", "Attack", attackRange, 0.5f, nullptr, nullptr);
    apvts.createAndAddParameter("Decay", "Decay", "Decay", decayRange, 0.1f, nullptr, nullptr);
    apvts.createAndAddParameter("Sustain", "Sustain", "Sustain", sustainRange, 0.8f, nullptr, nullptr);
    apvts.createAndAddParameter("Release", "Release", "Release", releaseRange, 5.0f, nullptr, nullptr);

    apvts.createAndAddParameter("Volume", "Volume", "Volume", volumeRange, 0.85f, nullptr, nullptr);
}
...
void LaplandAudioProcessor::updateKeyFreq(double midiKeyFreq)
{
    ...
    lastMicroTune = *apvts.getRawParameterValue("MicroTune");
...
void LaplandAudioProcessor::updateMicroTune()
{
    lastMicroTune = *apvts.getRawParameterValue("MicroTune");
    ...
    for (int i = 0; i < lapland.getNumVoices(); ++i)
    {
        if (auto voice = dynamic_cast<SynthVoice*>(lapland.getVoice(i)))
        {
            voice->updateKeyFreqMicro(lastMicroTune);
        }
    }
}
